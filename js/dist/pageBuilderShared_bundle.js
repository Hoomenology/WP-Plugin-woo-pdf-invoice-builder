...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/app/Shared/RedNaoPDFShared.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/app/Shared/EventManager/EventManager.ts":
/*!*****************************************************!*\
  !*** ./src/app/Shared/EventManager/EventManager.ts ***!
  \*****************************************************/
...
var RNEvent_1 = __webpack_require__(/*! ./RNEvent */ "./src/app/Shared/EventManager/RNEvent.ts");
var EventManager = /** @class */ (function () {
    function EventManager() {
        this.OnSave = new rxjs_1.Subject();
        this.OnSettingsContentCreated = new rxjs_1.Subject();
        this.BeforeClosingSettings = new rxjs_1.Subject();
        this.GetAdditionalButtons = new RNEvent_1.RNEvent();
        this.GetSettingTabs = new RNEvent_1.RNEvent();
    }
    return EventManager;
}());
...
/***/ "./src/app/Shared/EventManager/RNEvent.ts":
/*!************************************************!*\
  !*** ./src/app/Shared/EventManager/RNEvent.ts ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var RNEvent = /** @class */ (function () {
    function RNEvent() {
        this.subscribers = [];
    }
    RNEvent.prototype.Subscribe = function (callback, id) {
        if (id === void 0) { id = ''; }
    ...
    RNEvent.prototype.UnsubscribeByCallBack = function (callback) {
        this.Unsubscribe(this.subscribers.find(function (x) { return x.CallBack == callback; }));
    };
    RNEvent.prototype.UnsubscribeById = function (id) {
        this.Unsubscribe(this.subscribers.find(function (x) { return x.Id == id; }));
    };
    RNEvent.prototype.Unsubscribe = function (item) {
        this.subscribers.splice(this.subscribers.indexOf(item), 1);
    };
    RNEvent.prototype.Publish = function (args) {
...
exports.RNEvent = RNEvent;
var SubscribeItem = /** @class */ (function () {
...
/***/ "./src/app/Shared/RedNaoPDFShared.ts":
/*!*******************************************!*\
  !*** ./src/app/Shared/RedNaoPDFShared.ts ***!
  \*******************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventManager_1 = __webpack_require__(/*! ./EventManager/EventManager */ "./src/app/Shared/EventManager/EventManager.ts");
var RedNaoPDFShared = /** @class */ (function () {
    function RedNaoPDFShared() {
    }
    RedNaoPDFShared.EventManager = new EventManager_1.EventManager();
    return RedNaoPDFShared;
}());
exports.default = RedNaoPDFShared;
window.RedNaoPDFShared = exports;


/***/ })

/******/ });
//# sourceMappingURL=pageBuilderShared_bundle.js.map