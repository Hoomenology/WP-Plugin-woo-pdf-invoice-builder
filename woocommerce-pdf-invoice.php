...
final class RednaoWooCommercePDFInvoice{
    ...
    public function __construct()
    {
        ...
        RednaoWooCommercePDFInvoice::$DIR=WP_PLUGIN_DIR.'/'.RednaoWooCommercePDFInvoice::$NAME.'/';
    ...
    public function AddDeactivationDialog(){
        echo '<script type="text/javascript">var rednaoAdminEmail="'.get_site_option('admin_email').'"</script>';
    ...
    public function UpdateDBIfNeeded(){
        $dbversion=get_site_option("WC_PDF_INVOICE_LATEST_DB_VERSION",0);
        if($dbversion<RednaoWooCommercePDFInvoice::$DBVERSION)
        {
            ...
            update_site_option("WC_PDF_INVOICE_LATEST_DB_VERSION", RednaoWooCommercePDFInvoice::$DBVERSION);
        }
...
function RedNaoWCInvLoader($className)
{
    if(strpos($className,'rnwcinv\\')!==false)
    {
        ...
        include_once RednaoWooCommercePDFInvoice::$DIR.$path.'.php';
    }
}

global $RednaoWooCommercePDFInvoiceInstance;
$RednaoWooCommercePDFInvoiceInstance=new RednaoWooCommercePDFInvoice();
